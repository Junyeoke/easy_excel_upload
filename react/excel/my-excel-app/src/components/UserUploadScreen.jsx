              ...
              <div className="workspace-side-stack workspace-side-stack-sticky">
                <div className={`workspace-card workspace-card-${hasKnownFailedRows || hasUnknownFailedRows ? 'warning' : 'positive'} workspace-card-command`}>
                  ...
                  <div className="workspace-action-stack">
                    ...
                    {(hasKnownFailedRows || editedRowCount > 0) && (
                      <div style={{ border: '1px solid #e2e8f0', borderRadius: '8px', padding: '8px', background: '#f8fafc' }}>
                        ...
                        <button className="side-action-btn" style={{ width: '100%', marginTop: '8px' }} onClick={runPolicyRetry} disabled={previewLoading || validating}>
                          정책 기준 재처리 실행
                        </button>
                      </div>
                    )}
...
const UserUploadScreen = ({
  ...
  return (
    <div className="wizard-shell excel-facelift-shell excel-facelift-user-shell">
